...
public class AddCustomer extends javax.swing.JFrame {
    ...
    public AddCustomer() {
        ...
        try {
            randomId = "KH" + Function.generateUniqueRandomString(con, "khach_hang", "ma_khach_hang", 8);
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            ...
            PreparedStatement pr = con.prepareStatement("INSERT INTO khach_hang (ma_khach_hang, ten_khach_hang, dia_chi, so_dien_thoai, email) VALUE (?,?,?,?,?)");
